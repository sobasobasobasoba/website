...
function Header() {
  return (
    <header className="bg-gradient-to-r from-emerald-700 via-emerald-600 to-white text-white p-4 shadow-lg">
    ...
    <main className="container mx-auto p-6 bg-white">
      <div className="rounded-2xl p-6 shadow-md">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {TEAMS.map((t) => 
          (
            <div className={`p-4 border border-emerald-500 rounded hover:shadow-[0_0px_10px_rgba(0,0,0,0.25)] ${t.active ? "" : "bg-gray-200"}`}>
            <Link key={t.id} to={`/team/${t.id}`} >
              <img className={`h-48 w-96 object-contain drop-shadow-[0_0px_10px_rgba(0,0,0,0.25)] ${t.active ? "" : "grayscale-75"}`} src={t.logo}/>
              ...
              {Object.entries(matchupInfo.blowout).map(([m]) => {
                ...
                return (
                  <tr key={m + 1} className="hover:bg-slate-50">
                    ...
                    <td className="p-4 border-b border-slate-200">
                      <div className="max-h-24 overflow-y-auto">
                        <img className="object-scale-down max-h-12 max-w-12 drop-shadow-[0_0px_5x_rgba(0,0,0,0.25)] inline" src={winningTeam.logo}/>
                      </div>
                    </td>
                    <td className="p-4 border-b border-slate-200">
                      <div className="max-h-24 overflow-y-auto">
                    ...
                    <td className="p-4 border-b border-slate-200">
                      <div className="max-h-24 overflow-y-auto">
                        <img className="object-scale-down max-h-12 max-w-12 drop-shadow-[0_0px_5px_rgba(0,0,0,0.25)] inline" src={losingTeam.logo}/>
                      </div>
                    </td>
                    <td className="p-4 border-b border-slate-200">
                      <div className="max-h-24 overflow-y-auto">
              ...
              {Object.entries(matchupInfo.closest).map(([m]) => {
                ...
                return (
                  <tr key={m + 1} className="hover:bg-slate-50">
                    ...
                    <td className="p-4 border-b border-slate-200">
                      <div className="max-h-24 overflow-y-auto">
                        <img className="object-scale-down max-h-12 max-w-12 drop-shadow-[0_0px_5px_rgba(0,0,0,0.25)] inline" src={winningTeam.logo}/>
                      </div>
                    </td>
                    <td className="p-4 border-b border-slate-200">
                      <div className="max-h-24 overflow-y-auto">
